<?php
/**
 * Master Official Seeder for the 10 Official Clubs at UIT:
...
try {
    ...
    // 3. Seed Official Events (GDGoC + GFG + HackerRank + E-Cell + WikiClub + FOSS + Rotaract + Toastmasters + FlutterFlow + TEDxUIT)
    $events = [
        [
    ...
    echo "[-] Error seeding official 10 clubs: " . $e->getMessage() . "\n";
}
