<?php
/**
 * Master Official Seeder for the 7 Official Clubs at UIT:
...
try {
    ...
    echo "===========================================\n";
    echo "  Seeding 7 Official Campus Clubs into Database \n";
    echo "===========================================\n";
    ...
    // 3. Seed Official Events (GDGoC + GFG + HackerRank + E-Cell + WikiClub + FOSS + Rotaract)
    $events = [
        [
    ...
    echo "===========================================\n";
    echo "  Official 7 Clubs Database Seeded!        \n";
    echo "===========================================\n";

} catch (Exception $e) {
    echo "[-] Error seeding official 7 clubs: " . $e->getMessage() . "\n";
}
