<?php
/**
 * Master Official Seeder for the 9 Official Clubs at UIT:
...
try {
    ...
    echo "===========================================\n";
    echo "  Seeding 9 Official Campus Clubs into Database \n";
    echo "===========================================\n";
    ...
    // 3. Seed Official Events (GDGoC + GFG + HackerRank + E-Cell + WikiClub + FOSS + Rotaract + Toastmasters + FlutterFlow)
    $events = [
        [
    ...
    echo "===========================================\n";
    echo "  Official 9 Clubs Database Seeded!        \n";
    echo "===========================================\n";

} catch (Exception $e) {
    echo "[-] Error seeding official 9 clubs: " . $e->getMessage() . "\n";
}
