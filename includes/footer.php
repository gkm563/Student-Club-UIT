        ...
        <div class="row g-4 mb-5 text-center text-lg-start">
            ...
            <div class="col-6 col-lg-2 mb-4 mb-lg-0 px-2">
                ...
                <ul class="footer-links">
                    <li><a href="<?= $assetPrefix ?>index.html"><i class="bi bi-chevron-right"></i> Home</a></li>
                    <li><a href="<?= $assetPrefix ?>clubs.html"><i class="bi bi-chevron-right"></i> Clubs Directory</a></li>
                    <li><a href="<?= $assetPrefix ?>events.html"><i class="bi bi-chevron-right"></i> Campus Events</a></li>
                    <li><a href="<?= $assetPrefix ?>gallery.html"><i class="bi bi-chevron-right"></i> Moments Gallery</a></li>
                </ul>
            </div>
            ...
            <div class="col-6 col-lg-2 mb-4 mb-lg-0 px-2">
                ...
                <ul class="footer-links">
                    <li><a href="<?= $assetPrefix ?>about.html"><i class="bi bi-chevron-right"></i> About Portal</a></li>
                    <li><a href="<?= $assetPrefix ?>contact.html#proposal"><i class="bi bi-chevron-right"></i> Submit Proposal</a></li>
                    <li><a href="<?= $assetPrefix ?>admin/dean-login.php"><i class="bi bi-chevron-right"></i> Dean Admin Portal</a></li>
                    <li><a href="<?= $assetPrefix ?>club-login.php"><i class="bi bi-chevron-right"></i> Club Lead Login</a></li>
                </ul>
            </div>
