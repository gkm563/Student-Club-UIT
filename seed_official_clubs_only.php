<?php
/**
 * Master Official Seeder: Retains ONLY the 2 Official Clubs at UIT:
...
try {
    ...
    echo "===========================================\n";
    echo "  Seeding Official Campus Clubs (GDGOC & GFG) \n";
    echo "===========================================\n";

    // 1. Fetch Technical Category ID
    ...
    // 3. Seed Official Leadership Roster
    $leaders = [
    ...
    // 4. Seed Official Events (GDGoC UIT 8 Events + GFG SC UIT Events)
    $events = [
        [
    ...
    echo "===========================================\n";
    echo "  Official Database Seeded Successfully!   \n";
    echo "===========================================\n";
