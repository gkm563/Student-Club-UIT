<?php
/**
 * Master Official Seeder for the 4 Official Clubs at UIT:
...
try {
    ...
    echo "===========================================\n";
    echo "  Seeding 4 Official Campus Clubs into Database \n";
    echo "===========================================\n";
    ...
    // 3. Seed Official Events (GDGoC + GFG + HackerRank + E-Cell)
    $events = [
        [
    ...
    echo "===========================================\n";
    echo "  Official 4 Clubs Database Seeded!        \n";
    echo "===========================================\n";

} catch (Exception $e) {
    echo "[-] Error seeding official 4 clubs: " . $e->getMessage() . "\n";
}
