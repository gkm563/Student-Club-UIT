<?php
/**
 * Master Official Seeder for the 8 Official Clubs at UIT:
...
try {
    ...
    echo "===========================================\n";
    echo "  Seeding 8 Official Campus Clubs into Database \n";
    echo "===========================================\n";
    ...
    // 3. Seed Official Events (GDGoC + GFG + HackerRank + E-Cell + WikiClub + FOSS + Rotaract + Toastmasters)
    $events = [
        [
    ...
    echo "===========================================\n";
    echo "  Official 8 Clubs Database Seeded!        \n";
    echo "===========================================\n";

} catch (Exception $e) {
    echo "[-] Error seeding official 8 clubs: " . $e->getMessage() . "\n";
}
